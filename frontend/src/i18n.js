const I18N = {
    en: {
        ...
        cart: {
            ...
            plateEmptyTitle: "Your plate is empty",
            plateEmptySubtitle: "Go back to the menu to add items to your order.",
            viewMenu: "View Menu",
            clearAll: "Clear All",
            clearAllConfirm: "Remove all items from your order?",
            cleared: "All items removed",
    ...
    mk: {
        ...
        cart: {
            ...
            currentOrder: "Тековна нарачка",
            previousOrders: "Претходни нарачки",
            plateEmptyTitle: "Вашата чинија е празна",
            plateEmptySubtitle: "Вратете се на менито за да додадете артикли во нарачката.",
            viewMenu: "Види мени",
            clearAll: "Избриши сѐ",
            clearAllConfirm: "Да ги отстранам сите ставки од вашата нарачка?",
            cleared: "Сите артикли се отстранети.",
