...
const RESTAURANT_COORDS = { lat: 45.546492, lng: 13.729156 };   // Should probably change this later to automate for each restaurant.
...
function Cart({
    ...
    const verifyWithinRestaurant = async () => {
